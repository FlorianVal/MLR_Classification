...
def train(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, data in enumerate(trainloader, 0):
            ...
            # Compute MLR loss
            loss = mlr_loss(features, targets, permuted_targets, model.tikhonov)
        ...
        with torch.no_grad():
            for data in testloader:
                ...
                outputs = model.classify(model(images))
...
def main():
    ...
    parser.add_argument('--num-permutations', type=int, default=5, help='number of permuted datasets (default: 1)')
